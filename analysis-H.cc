...
int main(int argc, char* argv[]) {
  ...
  std::pair<double, double> fCalib = std::make_pair(1929./20., 26660./20.); // <ceren, scint> 1929./20., 26660./20(1.25m)
  ...
  TH1F* tE_DR = new TH1F("E_C+S", "Total Energy;GeV;Evt", 100, low, high);
  ...
  TF1* grE_DR = new TF1("Totalfit", "gaus", low, high);
  ...
  tE_DR->SetOption("p"); tE_DR->Fit(grE_DR, "R+&same");
  tE_DR->Draw(""); c->SaveAs(outputname+"_E_DR.png");
